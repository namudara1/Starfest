...
$sql = "SELECT e.event_name, eo.firstname,eo.lastname,p.amount,p.date_time  FROM payment p
	join event e on e.event_id=p.event_id
	join event_organizer eo on eo.eo_id=p.eo_id
	join service_provider s on s.sp_id=p.sp_id where s.id=$id";
...
<body>
    ...
    <div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                    ...
                    <h2 class="title">service provider payment details</h2>
                        </div>   
                    <div class="card-body">
                    <form >
                        <div class="form-row">
	...
	<table>
        ...
        <tr>
        <th>event_name</th>
        <th>Event organizer firstname</th>
        <th>Event organizer lastname</th>
        <th>Amount</th>
        <th>Date and time</th>
        </tr>
