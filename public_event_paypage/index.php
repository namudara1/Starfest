...
// if (isset($user_id)) {
//     if($_SESSION['free_event_chk'] == 60){
//         header('Location: free_events/index.php');
//     }
// }
        ...
        <div class="container">
            ...
            <div class="ticket_container">
                ...
                <table id="ticket_table">
                    <tr>
                        <th>
                            <h2 class="text1">Description</h2>
                        </th>
                        <th>
                            <h2 class="text1">Ticket Price</h2>
                        </th>
                        <th>
                            <h2 class="text1">Add to Cart</h2>
                        </th>
                    </tr>
            ...
            <div class="cart_button">
                <button id="redirect_cart_btn" class="cart_bt" href="">
                    <h3>CART</h3>
                </button>
            </div>
        </div>
