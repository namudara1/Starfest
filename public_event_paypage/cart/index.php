...
<div class="center">
    <div class="container">
        ...
        <table id="carttable">
            <tr>
                <th><h2 class="text2">DESCRIPTION</h2></th>
                <th><h2 class="text3">QUANTITY</h2></th>
                <th><h2 class="text4">TOTAL</h2></th>
                <th><h2 class="text5">REMOVE</h2></th>
            </tr>
            <?php
        ...
        <div class="check_out">
            <!-- <a href="../paypage/payment.php?m=<?php echo $event_name; echo $amount ?>"><button class="chk-out" >Check Out</button> -->
